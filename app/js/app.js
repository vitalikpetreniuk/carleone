...
document.addEventListener('DOMContentLoaded', () => {
    ...
    $('#callMeBack, .call-me, .card-info .open-popup, .card-info > .button, .page-category .card-info > .button-secondary, .page-product .card-info > .button-secondary, #openPopup, #calculateTheCost').on('click', function (e) {
        e.preventDefault()
